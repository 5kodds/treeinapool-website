...
import { CURRENCY_NOTE, SERVICES, SHOW_WHATSAPP } from "@/lib/site";
        ...
        <Container className="grid gap-12 md:grid-cols-[7fr_4fr] md:items-end">
          <div>
            ...
            <p className="mt-7 max-w-[56ch] text-[17px] leading-7 text-muted">
              Every engagement is priced and dated before it starts. Pick the one that matches
              where you are; if none of them do, the discovery call sorts it out.
            </p>
          </div>
          <Frame className="p-0">
        ...
        <Container>
          <Frame className="p-0">
                ...
                <tbody>
                  {SERVICES.map((s) => (
                    <tr key={s.id}>
                      ...
                      <td className="whitespace-nowrap text-lg">{s.timeline}</td>
            ...
            <p className="m-0 border-t border-[var(--color-divider)] px-6 py-3 text-[13px] leading-6 text-muted">
              Bands are placeholders pending the founder&apos;s final numbers (decision D3). Final
              scope and price are confirmed in writing after the discovery call.
            </p>
          </Frame>
        </Container>
      </section>
        ...
        >
          <Container className="grid gap-12 md:grid-cols-[4fr_8fr]">
            <div>
              ...
              <p className="mt-4 text-[15px] leading-6 text-muted">{s.summary}</p>
              <div className="mt-6">
                <CtaLink href="/contact" page="services" position={`detail-${s.code}`}>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <Frame className="p-5">
                ...
                <div className="flex justify-between gap-3 border-b border-[var(--color-divider)] py-2 text-sm">
                  <span>Timeline</span>
                  <span className="whitespace-nowrap text-lg">{s.timeline}</span>
                </div>
                <div className="flex justify-between gap-3 border-b border-[var(--color-divider)] py-2 text-sm">
                  <span>From</span>
        ...
        <Container className="grid gap-10 md:grid-cols-[7fr_5fr] md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-[52ch] text-base leading-7 text-muted">
              That is what the discovery call is for. Thirty minutes, and you leave with a
              recommendation in writing — including &quot;you don&apos;t need us yet&quot; when
