---
title: "Fixed price vs. time and materials, honestly compared"
date: 2026-08-19
category: "Working together"
summary: "Both pricing models can be fair, and both can be used badly. A plain look at what each one really costs you, and how to tell which one a project deserves."
draft: false
---
...
1. What specifically happens when scope changes? Get the mechanism, not the reassurance.
2. What's the buffer in this number, and what happens to it if the work goes smoothly?
3. What am I paying for in week one that I'd still have if we stopped in week two?
4. Who owns the code and the accounts if this ends early?
